...
import com.ekocbiyik.component.OfficeEditWindow;
 ...
 */
public class AdminShowOfficesView extends Panel implements View {


    private VerticalLayout root;
    private Table officesTable;

    public AdminShowOfficesView() {
    ...
    private Component buildContent() {
        ...
        officesTable = new Table("Offices", itemContainer);
        ...
        officesTable.addGeneratedColumn("edit", new ColumnGenerator() {
            @Override
            public Object generateCell(Table source, Object itemId, Object columnId) {
                Button b = new Button("Edit Office");
                b.addStyleName(ValoTheme.BUTTON_DANGER);
                b.addClickListener(new ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent clickEvent) {

                        Window w = new OfficeEditWindow((Office) itemId, officesTable);
